...
| Frequency Redesign — Gate 1 (Iteration → Documentation) | 2026-03-19 | Project Lead | Pending | Merge WEEKLY+CUSTOM, computed dueDays, shared frequency service, backwards compatible, CUSTOM deprecated. |
